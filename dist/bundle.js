 ...
 * http://polymer.github.io/PATENTS.txt
 */
const L=(t,e)=>`${t}--${e}`;let I=!0;void 0===window.ShadyCSS?I=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected.Please update to at least @webcomponents/webcomponentsjs@2.0.2 and@webcomponents/shadycss@1.3.1."),I=!1);const q=t=>e=>{const n=L(e.type,t);let s=V.get(n);void 0===s&&(s={stringsArray:new WeakMap,keyString:new Map},V.set(n,s));let r=s.stringsArray.get(e.strings);if(void 0!==r)return r;const o=e.strings.join(h);if(void 0===(r=s.keyString.get(o))){const n=e.getTemplateElement();I&&window.ShadyCSS.prepareTemplateDom(n,t),r=new m(e,n),s.keyString.set(o,r)}return s.stringsArray.set(e.strings,r),r},F=["html","svg"],W=new Set,J=(t,e,n)=>{W.add(n);const s=t.querySelectorAll("style");if(0===s.length)return void window.ShadyCSS.prepareTemplateStyles(e.element,n);const r=document.createElement("style");for(let t=0;t<s.length;t++){const e=s[t];e.parentNode.removeChild(e),r.textContent+=e.textContent}if((t=>{F.forEach(e=>{const n=V.get(L(e,t));void 0!==n&&n.keyString.forEach(t=>{const{element:{content:e}}=t,n=new Set;Array.from(e.querySelectorAll("style")).forEach(t=>{n.add(t)}),R(t,n)})})})(n),function(t,e,n=null){const{element:{content:s},parts:r}=t;if(null==n)return void s.appendChild(e);const o=document.createTreeWalker(s,$,null,!1);let i=U(r),a=0,l=-1;for(;o.nextNode();)for(l++,o.currentNode===n&&(a=j(e),n.parentNode.insertBefore(e,n));-1!==i&&r[i].index===l;){if(a>0){for(;-1!==i;)r[i].index+=a,i=U(r,i);return}i=U(r,i)}}(e,r,e.element.content.firstChild),window.ShadyCSS.prepareTemplateStyles(e.element,n),window.ShadyCSS.nativeShadow){const n=e.element.content.querySelector("style");t.insertBefore(n.cloneNode(!0),t.firstChild)}else{e.element.content.insertBefore(r,e.element.content.firstChild);const t=new Set;t.add(r),R(e,t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
